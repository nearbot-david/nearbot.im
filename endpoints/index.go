    ...
    <section style="text-align: center;">
		...
		<p>
			<video loop muted autoplay class="video">
				<source src="https://textmoney.mznx.dev/demo.mp4?v3" type="video/mp4"/>
            </video>
		</p>

		<p>Пополняйте баланс с банковской карты, переводите деньги друзьям и знакомым, не покидая мессенджер.</p>

		<a class="block" href="https://t.me/textmoneybot">Перейти в бота</a>

		<p><a href="javascript://">Часто задаваемые вопросы</a></p>
    </section>
</div>
</body>
</html>`
